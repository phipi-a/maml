...
class DataGenerator(object):
    ...
    def __init__(self, num_samples_per_class, batch_size, config={}):
        ...
        if FLAGS.datasource == 'sinusoid':
            ...
            data_folder = config.get('data_folder', data_path+'omniglot_resized')
            ...
            self.dim_output = self.num_classes
            metatrain_folder = config.get('metatrain_folder', data_path+'miniImagenet/train')
            if FLAGS.test_set:
                metaval_folder = config.get('metaval_folder', data_path+'miniImagenet/test')
            else:
                metaval_folder = config.get('metaval_folder', data_path+'miniImagenet/val')
    ...
    def make_data_tensor(self, train=True):
        if train:
            ...
            if FLAGS.analyse:
                num_total_batches = FLAGS.num_testpoints
                random.seed(2)
